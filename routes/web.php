...
$router->group(['middleware' => 'auth:api', 'prefix' => '/api'], function ($router) {
    ...
    $router->get('/projects/{uuid}', 'ProjectController@show');
    $router->put('/projects/{uuid}', 'ProjectController@update');
    $router->delete('/projects/{uuid}', 'ProjectController@destroy');

    $router->get('/tasks', 'TaskController@index');
    $router->post('/tasks', 'TaskController@store');
    $router->get('/tasks/{uuid}', 'TaskController@show');
    $router->put('/tasks/{uuid}', 'TaskController@update');
    $router->delete('/tasks/{uuid}', 'TaskController@destroy');
    $router->get('/tasks/project/{project_uuid}', 'TaskController@showByProject');
});
