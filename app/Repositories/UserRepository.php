...
class UserRepository
{
    ...
    public function store($request)
    {
        $user = User::create([
            ...
            'profile_photo' => $this->uploadPhotoProfile($request->profile_photo),
    ...
    public function update($request, $user)
    {
        ...
        if (!empty($request->profile_photo)) {
            ...
            $data['profile_photo'] = $this->uploadPhotoProfile($request->profile_photo);
        }
    ...
    {
        $photoFileName = uniqid() . '.' . $request->getClientOriginalExtension();
        $request->move('images/profile-photos', $photoFileName);
